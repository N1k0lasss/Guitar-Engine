...
<style>
  ...
  .controls-panel { display: flex; flex-direction: column; gap: var(--sp-3); margin-bottom: var(--sp-4); }
  .rootrow { display: flex; flex-wrap: wrap; gap: 6px; }
  .rootchip { font-family: var(--font-mono); font-size: 12px; padding: 7px 10px; border: 1px solid var(--line); border-radius: 2px; background: var(--panel-raised); color: var(--muted); cursor: pointer; }
  ...
  .nnote { font-family: var(--font-mono); font-size: 13px; padding: 7px 10px; border-radius: 2px; border: 1px solid var(--line); background: var(--panel-raised); color: var(--ink); }
  .tensions-grid { display: grid; gap: 16px; grid-template-columns: repeat(auto-fit, minmax(260px, 1fr)); margin-top: 16px; }
  .tcard { padding: 16px; border: 1px solid #555954; border-radius: 2px; background: #121414; }
  ...
  .tlabel { font-family: var(--font-display); font-size: 24px; font-weight: 700; letter-spacing: -0.5px; color: var(--accent); }
  .tnote { font-family: var(--font-mono); font-size: 13px; color: var(--ink); }
  .tkind { color: var(--muted); font: 10px 'DM Mono', monospace; letter-spacing: 1.5px; text-transform: uppercase; margin: 8px 0; }
  ...
  .tdesc { color: var(--muted); font-size: 13px; line-height: 1.55; margin: 0 0 12px; }
  .counts { display: flex; gap: 8px; margin: 12px 0; }
  .count { font-family: var(--font-mono); font-size: 11px; padding: 5px 8px; border-radius: 2px; border: 1px solid var(--line); color: var(--muted); }
  .count[data-on="true"] { color: var(--accent); border-color: color-mix(in srgb, var(--accent) 50%, var(--line)); }
  .ruling { display: flex; flex-direction: column; gap: 4px; padding: 12px; border-radius: 2px; background: var(--panel-raised); border: 1px solid var(--line); }
  ...
  .full { margin-top: 12px; font-size: 11px; color: var(--muted); line-height: 1.6; }
</style>